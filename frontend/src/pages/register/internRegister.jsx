                    ...
                    <div className="flex-1 flex flex-col items-center p-6 sm:p-8 lg:p-12 bg-gradient-to-br from-gray-50 to-gray-100 my-20">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
                                ...
                                adipisicing elit. Perferendis voluptates, esse
                                unde eos aliquid pariatur a animi minus beatae
                                distinctio ex ducimus. Molestias rerum
                                doloremque odio nisi iste quis accusamus!
                            </p>
                        </div>
